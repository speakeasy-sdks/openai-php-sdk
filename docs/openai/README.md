...
try {
    ...
    $request->bestOf = 613064;
    $request->echo = false;
    $request->frequencyPenalty = 4370.32;
    $request->logitBias = [
        'quidem' => 'architecto',
        'ipsa' => 'reiciendis',
        'est' => 'mollitia',
    ...
    $request->logprobs = 210382;
    $request->maxTokens = 16;
    $request->model = 'corporis';
    $request->n = 1;
    $request->presencePenalty = 1289.26;
    $request->prompt = [
        [
            363711,
            325047,
...
try {
    ...
    $request->model = 'mollitia';
    $request->user = 'dolorem';
...
try {
    ...
    $request->file->file = 'consequuntur';
    $request->purpose = 'repellat';
...
try {
    ...
    $request->image->content = 'enim';
    $request->image->image = 'odit';
    $request->mask = new CreateImageEditRequestMask();
    $request->mask->content = 'quo';
    $request->mask->mask = 'sequi';
    $request->n = 'tenetur';
    $request->prompt = 'A cute baby sea otter wearing a beret';
    $request->responseFormat = 'ipsam';
    $request->size = 'id';
    $request->user = 'possimus';
...
try {
    ...
    $request->image->content = 'aut';
    $request->image->image = 'quasi';
    $request->n = 'error';
    $request->responseFormat = 'temporibus';
    $request->size = 'laborum';
    $request->user = 'quasi';
...
try {
    ...
    $request->createSearchRequest->file = 'omnis';
    $request->createSearchRequest->maxRerank = 451159;
    $request->createSearchRequest->query = 'the president';
    $request->createSearchRequest->returnMetadata = false;
    $request->createSearchRequest->user = 'cum';
...
try {
    ...
    $request->file->content = 'perferendis';
    $request->file->file = 'doloremque';
    $request->language = 'reprehenderit';
    $request->model = 'ut';
    $request->prompt = 'maiores';
    $request->responseFormat = 'dicta';
    $request->temperature = 3594.44;
...
try {
    ...
    $request->file->file = 'iusto';
    $request->model = 'dicta';
    $request->prompt = 'harum';
    $request->responseFormat = 'enim';
    $request->temperature = 8804.76;
