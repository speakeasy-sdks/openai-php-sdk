...
class FineTunes 
{
    ...
    ): \Openai\SDK\Models\Operations\CancelFineTuneResponse
    {
        ...
        $request = new \Openai\SDK\Models\Operations\CancelFineTuneRequest();
        $request->fineTuneId = $fineTuneId;
    ...
    ): \Openai\SDK\Models\Operations\ListFineTuneEventsResponse
    {
        ...
        $request = new \Openai\SDK\Models\Operations\ListFineTuneEventsRequest();
        $request->fineTuneId = $fineTuneId;
    ...
    ): \Openai\SDK\Models\Operations\RetrieveFineTuneResponse
    {
        ...
        $request = new \Openai\SDK\Models\Operations\RetrieveFineTuneRequest();
        $request->fineTuneId = $fineTuneId;
